...
- **Regional distribution of this ensemble:** [PE-ARPEGE EURAT01](./pe-arpege-eurat01.md) — same 35 members at 0.1° over Europe/Atlantic, ~103 GB per cycle against GLOB025's ~213 GB.
- **Regional sibling ensemble:** [PE-AROME](../../regional/fr/pe-arome.md), the convection-permitting AROME ensemble over Western Europe, coupled to PE-ARPEGE for its lateral boundary conditions.
...
- **Also in this bucket:** `prod/data/arome/ncaled0025/` — a New Caledonia AROME ensemble, presumably part of **PEAROME-OM**. Its presence means at least some of the AROME ensemble family *is* available as bulk GRIB without an API key, contrary to what the [PE-AROME](../../regional/fr/pe-arome.md) entry currently states. **TBD** — worth investigating when that entry is revised.
