...
- **Public-data transition:** IMGW-PIB stated (June 2026) that it is changing its public model data **from COSMO to ICON-LAM**. No date has been announced, and [COSMO (Poland)](./cosmo-poland.md) remains published and complete as of 2026-08-16 — see that entry. ICON-LAM is not yet on the portal and remains a candidate future entry, out of scope until a free feed is confirmed.
