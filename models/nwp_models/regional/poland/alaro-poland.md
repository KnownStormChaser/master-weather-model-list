...
- **Data formats:** GRIB. **Flag:** files carry **no standard file extension** — they are named `fc<YYYYMMDD>_<HH>+<step>gl` (e.g. `fc20260609_18+000gl` … `fc20260609_18+099gl`). The trailing `gl` is of unverified meaning. IMGW confirmed the format is GRIB.
