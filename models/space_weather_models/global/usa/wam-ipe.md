...
- **Contents (verified):** 16 scalar time series on a **1-minute** axis (`ifp_interval: 60`), 2640 steps in the WRS sample and 2640 in the WFS sample — F10.7 and its 41-day average, Kp and its 24-hour average, Ap and its 24-hour average, northern and southern hemispheric power and their indices, and solar wind IMF total B, Bz, angle, velocity and density.
