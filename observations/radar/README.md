...
Several systems were evaluated and deliberately left out, for reasons worth recording:
...
Other national radar services with open gridded feeds may be added as they are verified.
...
1. Verify the data is genuinely free and downloadable through a permanent open channel (free registration is acceptable; paywalls and approval gates are not)
